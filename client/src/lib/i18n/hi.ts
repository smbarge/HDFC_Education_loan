export const hi = {
  ...
  documents: {
    ...
    subtitle: "कृपया आवेदन प्रक्रिया को सुचारू बनाने के लिए निम्नलिखित दस्तावेज़ तैयार रखें",
    applicant: {
  ...
  govtEmployeeGaurantor:'सरकारी कर्मचारी गारंटर',
  ...
  trueCorrectComplete: "सत्य, सही और पूर्ण",

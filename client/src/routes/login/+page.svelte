        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8">
          ...
          <form on:submit|preventDefault={handleLogin} class="space-y-6" autocomplete="off">
            ...
            <div class="flex items-center justify-between">
              ...
              <a href="/forgot-password" class="text-sm text-purple-600 hover:text-purple-700 hover:underline font-medium transition-colors duration-200">
          ...
          <div class="mt-6 pt-6 border-t border-gray-200">
            <p class="text-sm text-gray-600 text-center">
              {t('login.noAccount')}
              <a href="/registration" class="text-purple-600 font-semibold hover:text-purple-700 hover:underline transition-colors duration-200">
                {t('login.registerNow')}
              </a>
            </p>
          </div>

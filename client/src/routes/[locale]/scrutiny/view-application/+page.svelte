      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-purple-700 to-purple-900 px-6 sm:px-8 py-5">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <span class="inline-flex items-center gap-2 px-4 py-1.5 bg-purple-300 text-purple-900 rounded-full text-xs font-bold self-start">
              🏛️ Scrutiny View
            </span>
          </div>
        </div>
          ...
          <div class="border-b border-gray-200">
            ...
            <div class="px-6 sm:px-8 py-4 space-y-4">
              ...
              {#each appData.collateral.lics || [] as lic, i}
                <div>
                  <p class="text-xs font-bold text-purple-700 uppercase mb-2">LIC Policy {i + 1}</p>
                  <div class="grid grid-cols-2 sm:grid-cols-4 gap-x-8">
                    {#each [
